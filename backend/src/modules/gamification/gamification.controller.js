    ...
    try {
        ...
        if (
            ...
            return sendError(res, {
                statusCode: 403,
                message:
                    "You are not allowed to view this gamification profile",
            });
        }

        const data =
            await gamificationService.getStudentGamification(studentId);
    ...
    try {
        ...
        if (
            ...
            return sendError(res, {
                statusCode: 403,
                message:
                    "You are not allowed to view these gamification events",
            });
        }
        ...
        return sendError(res, {
            statusCode: 500,
            message:
                error.message || "Failed to get student gamification events",
        });
    }
};
