...
export const getStudentDashboardSummary = async (req, res) => {
    try {
        ...
        const data = await enrollmentService.getStudentDashboardSummary(
            studentId,
            {
                from,
                to,
...
export const getStudentAnalytics = async (req, res) => {
    try {
        ...
        const data = await enrollmentService.getStudentLearningAnalytics(
            studentId,
            {
                from,
                to,
    ...
    try {
        ...
        if (
            ...
            return sendError(res, {
                statusCode: 403,
                message:
                    "You are not allowed to export this analytics dashboard",
            });
        }
...
export const exportInstructorDashboardCsv = async (req, res) => {
    try {
        ...
        const csv = await enrollmentService.getInstructorDashboardCsv(
            instructorId,
            {
                from,
                to,
...
export const getInstructorCourses = async (req, res) => {
    try {
        ...
        const courses =
            await enrollmentService.getInstructorCourses(instructorId);
