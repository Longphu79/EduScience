...
export async function buildAdminDashboardPdf(dashboard = {}) {
    ...
    addMetricRow(
        doc,
        "Published Courses",
        formatNumber(stats.totalPublishedCourses),
    );
    addMetricRow(doc, "Draft Courses", formatNumber(stats.totalDraftCourses));
    addMetricRow(
        doc,
        "Archived Courses",
        formatNumber(stats.totalArchivedCourses),
    );
    addMetricRow(
        doc,
        "Total Enrollments",
    ...
    addMetricRow(
        doc,
        "Estimated Revenue",
        formatNumber(stats.estimatedRevenue),
    );
...
export async function buildInstructorDashboardPdf(summary = {}) {
    const { doc, endPromise } = createPdfDocument(
    ...
    addMetricRow(
        doc,
        "Average Quiz Score",
        formatNumber(summary.averageQuizScore),
    );
    addMetricRow(doc, "Quiz Pass Rate", formatPercent(summary.quizPassRate));
    addMetricRow(
        doc,
        "Total Assignments",
        formatNumber(summary.totalAssignments),
    );
    addMetricRow(
        doc,
        "Total Submissions",
    ...
    addMetricRow(
        doc,
        "Estimated Revenue",
        formatNumber(summary.estimatedRevenue),
    );
