...
export default function Toast({
    ...
    const positionClassMap = {
        ...
        "top-right": "fixed top-5 right-5 w-[min(92vw,420px)] z-[9999]",
        "bottom-center":
            "fixed bottom-8 left-1/2 -translate-x-1/2 w-[min(92vw,560px)] z-[9999]",
        "bottom-right": "fixed bottom-8 right-5 w-[min(92vw,420px)] z-[9999]",
        "action-zone": "fixed right-6 bottom-28 w-[min(92vw,430px)] z-[9999]",
    };
    ...
    return (
        <div
            className={
                positionClassMap[position] || positionClassMap["action-zone"]
            }
        >
            <div
