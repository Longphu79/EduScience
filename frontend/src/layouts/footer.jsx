                    ...
                    <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                        <div className="max-w-2xl">
                            ...
                            <h2 className="mt-4 text-3xl font-bold tracking-tight sm:text-4xl">
                                Learn smarter, grow faster, and build real-world
                                skills.
                            </h2>
                            <p className="mt-3 text-slate-300 leading-7">
                                Explore premium courses, structured learning
                                paths, and a modern learning experience designed
                ...
                <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
                    <div className="space-y-5">
                        ...
                        <p className="max-w-sm text-sm leading-7 text-slate-300">
                            A modern learning platform focused on practical
                            skills, premium design, and meaningful student
                            outcomes.
                        </p>
