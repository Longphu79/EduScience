...
import "../../shared/styles/allCoursesPage.css";
...
export default function AllCoursesPage() {
    ...
    const avgRating = (
        mockCourses.reduce((sum, item) => sum + item.rating, 0) /
        mockCourses.length
    ).toFixed(1);
        ...
        <div className="courses-page">
            ...
            >
                ...
                <div className="courses-hero__content">
                    ...
                    <p>
                        Explore high-quality online courses designed for
                        ambitious learners. Search, filter, and discover
                        expertly crafted programs built for real-world growth,
                        portfolio building, and long-term career value.
                    </p>

                    <div className="courses-hero__actions">
                        <Button
                            onClick={() =>
                                setToast("Start exploring our premium courses!")
                            }
                        >
                            Start Learning
                        </Button>
                ...
                <div className="courses-hero__panel">
                    <div className="hero-panel-card">
                        <p className="hero-panel-card__label">
                            Premium Learning Ecosystem
                        </p>
                        <h3>
                            Designed to feel immersive, elegant, and
                            professional
                        </h3>
                        ...
                        <ul>
                            ...
                            <li>
                                High-end UI with smooth, premium interactions
                            </li>
                            <li>
                                Focused learning designed for measurable
                                progress
                            </li>
                        </ul>
                        ...
                        <div className="hero-panel-footer">
                            <div>
                                <span className="hero-panel-footer__label">
                                    Trusted by learners
                                </span>
            ...
            <section className="courses-highlight">
                <div className="section-heading">
                    ...
                    <p>
                        Handpicked programs with excellent ratings, practical
                        outcomes, and high student engagement.
                    </p>
                </div>
            ...
            <section className="courses-benefits">
                <div className="section-heading">
                    ...
                    <p>
                        Strong visual design, clear course discovery, and
                        practical content structure help learners stay focused
                        and motivated.
                    </p>
                </div>
                ...
                <div className="benefit-grid">
                    <div className="benefit-card">
                        ...
                        <h3>Fast & focused</h3>
                        <p>
                            Modern catalog browsing with less friction and
                            cleaner discovery.
                        </p>
                    </div>
                    <div className="benefit-card">
                        ...
                        <p>
                            Content designed around real skills, real tools, and
                            real outcomes.
                        </p>
                    </div>
                    <div className="benefit-card">
                        ...
                        <p>
                            Learn comfortably across devices with a premium
                            visual experience.
                        </p>
                    </div>
                </div>
            ...
            <section className="courses-cta">
                <div className="courses-cta__inner">
                    <div>
                        ...
                        <p>
                            Join a platform built to help learners stay
                            inspired, focused, and future-ready with a polished
                            modern interface.
                        </p>
                    </div>
                    ...
                    <div className="courses-cta__actions">
                        <Button
                            onClick={() =>
                                setToast("You are ready to start learning!")
                            }
                        >
                            Join Now
                        </Button>
