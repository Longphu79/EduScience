    ...
    <div className="auth">
      ...
      <div className="auth__wrap">
        <div className="auth__brand">
          ...
          <div>
            <h1 className="brand__headline">Transform Your Learning Into Action</h1>
            <p className="brand__desc">
              A modern course platform with clean design and smooth experience for students and instructors.
            </p>
          ...
          <div className="brand__link">
            <Link to="/dashboard" className="brand__home">
              Go to dashboard
            </Link>
          </div>
        </div>
