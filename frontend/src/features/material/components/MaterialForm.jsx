            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                        Tạo mới hoặc cập nhật tài liệu cho khóa học bằng cách
                        tải file trực tiếp từ thiết bị.
                    </p>
                </div>
                ...
                <Field label="Upload file">
                    <label className="flex cursor-pointer flex-col items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-6 py-8 text-center transition hover:border-indigo-400 hover:bg-indigo-50/40">
                        ...
                        <span className="mt-1 text-xs text-slate-500">
                            PDF, DOCX, PPTX, XLSX, ZIP, TXT, MP4, MP3, PNG,
                            JPG...
                        </span>
                            ...
                            <div className="grid gap-2 text-sm text-slate-700">
                                ...
                                form.fileUrl ? (
                                    <p className="text-xs text-slate-500">
                                        Bạn đang chỉnh sửa tài liệu cũ. Có thể
                                        giữ nguyên file hiện tại hoặc chọn file
                                        mới để thay thế.
                                    </p>
                                ) : null}
                            </div>
