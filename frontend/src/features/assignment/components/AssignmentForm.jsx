...
import { getMinDueDateTimeValue } from "../utils/assignment.helpers";
...
export default function AssignmentForm({
    ...
    return (
        <form
            onSubmit={onSubmit}
            className="assignment-form assignment-form--card"
        >
            <div className="assignment-form__topbar">
                <div>
                    <div className="assignment-form__eyebrow">
                        Assignment Form
                    </div>
                    ...
                    <p className="assignment-form__subtitle">
                        Thiết lập bài tập với tiêu đề, mô tả, hạn nộp, điểm tối
                        đa và file đính kèm theo bố cục rõ ràng, hiện đại và
                        chuyên nghiệp.
                    </p>
                </div>
            ...
            <div className="assignment-form__grid">
                <div className="assignment-form__field">
                    <label className="assignment-form__label">
                        Assignment title
                    </label>
                    <input
                        type="text"
                ...
                <div className="assignment-form__row assignment-form__row--two">
                    ...
                    <div className="assignment-form__field">
                        ...
                        <input
                            ...
                            value={form.maxScore}
                            onChange={(event) =>
                                onChange("maxScore", event.target.value)
                            }
                        />
                    </div>
                </div>
                ...
                <div className="assignment-form__checkbox-group">
                    ...
                    <label className="assignment-form__checkbox-item">
                        <input
                            ...
                            onChange={(event) =>
                                onChange("isPublished", event.target.checked)
                            }
                        />
                        <span>Published</span>
                    </label>
                ...
                <div className="assignment-form__field">
                    ...
                    <p className="assignment-form__hint">
                        Hạn nộp không được ở quá khứ. Khi sửa assignment, bạn có
                        thể xóa file cũ hoặc thêm file mới.
                    </p>
                </div>
            </div>
