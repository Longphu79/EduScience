...
export async function getAssignmentsByCourse(courseId) {
    const response = await fetch(
        `${API_BASE_URL}/api/assignment/course/${courseId}`,
        {
...
export async function getAssignmentById(assignmentId) {
    const response = await fetch(
        `${API_BASE_URL}/api/assignment/${assignmentId}`,
        {
            headers: createHeaders({}, true),
        },
    );
...
export async function createAssignment(payload) {
    ...
    appendIfDefined(
        formData,
        "isPublished",
        String(payload?.isPublished !== false),
    );
...
export async function submitAssignment(assignmentId, payload) {
    ...
    const response = await fetch(
        `${API_BASE_URL}/api/assignment/${assignmentId}/submit`,
        {
            method: "POST",
            headers: createHeaders({}, true),
            body: formData,
...
export async function resubmitAssignment(assignmentId, payload) {
    ...
    const response = await fetch(
        `${API_BASE_URL}/api/assignment/${assignmentId}/resubmit`,
        {
            method: "PUT",
            headers: createHeaders({}, true),
            body: formData,
...
export async function getAssignmentSubmissionByStudentCourse(
    studentId,
    courseId,
) {
    const response = await fetch(
        `${API_BASE_URL}/api/assignment/submission/student/${studentId}/course/${courseId}`,
        {
            headers: createHeaders({}, true),
        },
    );
...
export async function getAssignmentSubmissionsByAssignment(assignmentId) {
    const response = await fetch(
        `${API_BASE_URL}/api/assignment/submission/assignment/${assignmentId}`,
        {
            headers: createHeaders({}, true),
        },
    );
...
export async function gradeAssignmentSubmission(submissionId, payload) {
    ...
    const response = await fetch(
        `${API_BASE_URL}/api/assignment/submission/${submissionId}/grade`,
        {
            method: "PATCH",
