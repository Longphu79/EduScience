    ...
    <div className="user-profile-page">
      <div className="user-profile-page__container">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <ProfileInfoCard label="Full name" value={profile?.fullName} />
          <ProfileInfoCard label="Username" value={profile?.username} />
          <ProfileInfoCard
            label="Joined"
            value={
              profile?.createdAt
        ...
        {isAdmin ? (
          <UserPublicAdminSection profile={profile} roleMeta={roleMeta} />
        ) : isInstructor ? (
