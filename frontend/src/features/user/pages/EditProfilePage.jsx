  ...
  return (
    <div className="edit-profile-page">
      <div className="edit-profile-page__container">
        ...
        <form onSubmit={handleSubmit} className="edit-profile-page__grid">
          <div className="space-y-6">
            ...
            >
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <ProfileField label="Phone" error={errors.phone}>
                  <input
                    name="phone"
                    value={form.phone}
                    onChange={handleChange}
            ...
            {isInstructor ? (
              ...
              >
                <ProfileField label="Expertise list" error={errors.expertiseText}>
                  <textarea
                    name="expertiseText"
              ...
              >
                <div className="rounded-2xl border border-red-200 bg-red-50 p-4 text-sm text-red-700">
                  Your admin profile is focused on identity, trust and clear
                  platform ownership. Headline, bio, avatar and cover image are
