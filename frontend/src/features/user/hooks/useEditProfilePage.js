...
export default function useEditProfilePage() {
    ...
    useEffect(() => {
        ...
        setForm({
            ...
            learningGoalsText: buildLinesFromArray(
                normalizedUser?.learningGoals,
            ),
        });
    }, [normalizedUser]);
        ...
        async (e) => {
            ...
            try {
                ...
                if (avatarFile?.file) {
                    ...
                    const avatarUser = normalizeUserItem(
                        userUnwrap(avatarResponse),
                    );
                ...
                if (coverFile?.file) {
                    ...
                    const coverUser = normalizeUserItem(
                        userUnwrap(coverResponse),
                    );
                    nextCoverImageUrl =
                        coverUser?.coverImageUrl || nextCoverImageUrl;
                }
                ...
                if (isInstructor) {
                    response = await updateInstructorProfile(
                        currentUserId,
                        payload,
                    );
