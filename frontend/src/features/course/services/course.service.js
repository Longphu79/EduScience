...
export async function getAllCourses(params = {}) {
    ...
    const res = await fetch(`${API_BASE_URL}/api/course${queryString}`, {
        method: "GET",
    });
...
export async function getPopularCourses() {
    const res = await fetch(`${API_BASE_URL}/api/course/popular`, {
        method: "GET",
    });
...
export async function getCourseDetail(courseId) {
    ...
    const res = await fetch(`${API_BASE_URL}/api/course/${courseId}`, {
        method: "GET",
    });
...
export async function getInstructorCourses(instructorId) {
    ...
    const res = await fetch(
        `${API_BASE_URL}/api/course/instructor/${instructorId}`,
        {
            method: "GET",
...
export async function createCourse(payload = {}) {
    ...
    const responsePayload = await handleResponse(
        res,
