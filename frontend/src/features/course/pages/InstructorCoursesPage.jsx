            ...
            <div className="instructor-courses-page">
                ...
                <div className="instructor-courses-page__auth-card">
                    ...
                    <p className="instructor-courses-page__auth-text">
                        Please login to manage your course catalog, lessons,
                        materials, quizzes, and learner interactions.
                    </p>
            ...
            <section className="instructor-courses-page__hero">
                <div className="instructor-courses-page__hero-layout">
                    <div>
                        ...
                        <h1 className="instructor-courses-page__title">
                            My Courses
                        </h1>

                        <p className="instructor-courses-page__subtitle">
                            Manage your teaching catalog with a smoother, more
                            professional workflow. Edit course details, organize
                            lessons, upload materials, create quizzes, and
                            monitor student activity in one place.
                        </p>
                    </div>
            ...
            {loading ? (
                <div className="instructor-courses-page__skeleton-grid">
                    {Array.from({ length: 6 }).map((_, index) => (
                        <div
                            key={index}
                            className="instructor-courses-page__skeleton-card"
                        >
                ...
                <div className="instructor-courses-page__empty-card">
                    ...
                    <p className="instructor-courses-page__empty-text">
                        Try another keyword or create your first course to get
                        started.
                    </p>
