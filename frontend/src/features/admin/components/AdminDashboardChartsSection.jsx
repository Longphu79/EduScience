...
function ChartEmpty() {
    return (
        <div className="admin-dashboard-chart-empty">No chart data yet.</div>
    );
}
...
function CustomTooltip({ active, payload, label }) {
    ...
    return (
        <div className="admin-dashboard-chart-tooltip">
            {label ? (
                <div className="admin-dashboard-chart-tooltip__label">
                    {label}
                </div>
            ) : null}
            {payload.map((item) => (
                <div
                    key={item.dataKey}
                    className="admin-dashboard-chart-tooltip__row"
                >
                    <span>{item.name}: </span>
...
export default function AdminDashboardChartsSection({
    ...
    const roleData = useMemo(
        () =>
            [
                ...
                {
                    name: "Instructors",
                    value: Number(stats.totalInstructors || 0),
                },
    ...
    const courseStatusData = useMemo(
        () =>
            [
                ...
                {
                    name: "Published",
                    value: Number(stats.totalPublishedCourses || 0),
                },
                {
                    name: "Archived",
                    value: Number(stats.totalArchivedCourses || 0),
                },
            ].filter((item) => item.value > 0),
        [stats],
    );
    ...
    return (
        <div className="admin-dashboard-chart-grid">
            ...
            <AdminSectionCard title="Top Categories" subtitle="By enrollments">
                {!categoryData.length ? (
                    <ChartEmpty />
                ) : (
                    <div className="admin-dashboard-chart-box">
            ...
            <AdminSectionCard title="Top Instructors" subtitle="By enrollments">
